...
# through webscraping approach for years 1989 to present
#

# Information available here:
# https://catalogue.ceda.ac.uk/uuid/f02cc6ddd92f45b18b9ab6ab544df7d9/

# N.B. May timeout so have to run several times
...
# Dataset link 
dataCEDA <- "https://data.ceda.ac.uk/badc/ukmo-hadobs/data/insitu/MOHC/HadOBS/HadUK-Grid/v1.3.1.ceda"
...
# Set years to ignore
yearCutoff <- 1989 # >1990 but need 1990 for winter cold [MTCO] calculation
...
destFolder <- "../Data/Spatial/HAD/rainfall"
